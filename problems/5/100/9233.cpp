...
{
private:
	long long int* pArray;
	long long int m_length;
public:
	PriorityQueue(long long int N) {
		// 为后续根节点直接从1开始作准备
		pArray = new long long int[N + 1];
		m_length = 0;
	}
